                        ...
                        <table class="table table-condensed">
                            ...
                            <tbody>
                                <tr class="active">
                                    ...
                                    <td class="text-center"><a href="index.php?style="><i class="fas fa-eye"></i></a></td>
                                    <td class="text-center"><a href="index.php?style="><i class="fa fa-download"></i></a></td>
                                </tr>
                                <tr class="success">
                                    <th scope="row">2</th>
      ...
      <div class="modal-body">
       ...
       <form action="index.php?style=">
          <div class="form-group">
            ...
            <a href="index.php?style="><input type="text" class="form-control" id="name">
          </div>
          <div class="form-group">
            <label for="fileupload">Tải sách lên:</label>
            <a href="index.php?style="><input type="file" class="form-control-file border" id="fileupload">
          </div>
